...
**Note:** The socket connection is established as soon as the module sends its first message using [sendSocketNotification](https://docs.magicmirror.builders/module-development/core-module-file.html#this-sendsocketnotification-notification-payload).
...
[  
](https://github.com/MagicMirrorOrg/MagicMirror-Documentation/blob/master/module-development/node-helper.md)
